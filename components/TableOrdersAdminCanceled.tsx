...
import { COLUMNS } from './TableOrdersAdminCanceled__Columns';

interface iTableOrders {
  orders: any[];
}

export default function TableOrdersAdminCanceled({ orders }: iTableOrders) {
  ...
  return (
    <>
      <div
        ...
        data-cy='tableOrdersAllPublished'
      >
