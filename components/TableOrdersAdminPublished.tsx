...
import { COLUMNS } from './TableOrdersAdminPublished__Columns';

interface iTableOrders {
  orders: any[];
}

export default function TableOrdersAdminPublished({ orders }: iTableOrders) {
  ...
  return (
    <div
      {...getTableProps()}
      className='w-full mb-40 border-solid border-zinc-200 overflow-scroll scrollbar-thin overflow-y-hidden scrollbar-thumb-zinc-300 scrollbar-track-zinc-100 hover:scrollbar-thumb-zinc-200 border-t'
    >
      <div>
