...
const OrdersAdminCanceled = () => {
  ...
  const {
    ...
    'ordersCanceled',
    ({ pageParam = 1 }) => api_ordersAdmin({ status: '5, 6', sort: 'desc', page: pageParam, country: router.query.lang as string }),
    {
  ...
  return (
    <>
      <Head>
        <title>AIDU | Отменённые заказы</title>
      ...
      <main>
        ...
        {ordersStatus === 'loading' || userStatus === 'loading' ? (
          ...
          <div className='container pl-50 pb-30 relative -mb-180'>
            <TableOrdersAdminCanceled orders={mergeOrdersPages(orders) || []} />
...
export default OrdersAdminCanceled;
